...
function textDirection(letter)
{
	var letterIndex = letter.charCodeAt(0);
	
	for(var script of SCRIPTS)
	{
		if(script.ranges.some(([from, to]) => { return letterIndex >= from && letterIndex < to;}))
		{
